...
RSpec.describe 'Projects Scenarios', :project_scenarios_api, type: :request do
  before do
  ...
  describe 'GET index' do
    it 'is not authorized without X-API-KEY' do
      get '/api/v1/projects/web-app/scenarios'
      expect(response.status).to eq(401)
    end

    it 'gets all projects' do
      get '/api/v1/projects/web-app/scenarios', headers: {
